...
def bg_image():
    ...
    # CSS for customizing the Streamlit header into a navbar
...
def app():
    ...
    # st.title("FlickNest")
    st.markdown("<h1><span style='color:yellow;'>Flick</span>Nest</h1>", unsafe_allow_html=True)
